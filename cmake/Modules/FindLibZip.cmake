...
foreach(pkg ZLIB BZip2 OpenSSL GnuTLS PkgConfig)
  find_package(${pkg} REQUIRED)
endforeach()

pkg_check_modules(PC_LIBZIP libzip)

find_path(LIBZIP_INCLUDE_ZIP NAMES zip.h HINTS ${PC_LIBZIP_INCLUDE_DIRS})

find_path(LIBZIP_INCLUDE_ZIPCONF NAMES zipconf.h HINTS ${PC_LIBZIP_INCLUDE_DIRS})

find_library(LIBZIP_LIBRARY NAMES zip HINTS ${PC_LIBZIP_LIBRARY_DIRS})
